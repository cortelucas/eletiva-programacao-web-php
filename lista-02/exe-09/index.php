...
<section class="container card shadow-lg mt-5 p-5">
    ...
    <form method="post">
        <div class="form-group row">
            <label for="valor1" class="col-sm-2 col-form-label">Informe um número inteiro: </label>
            <div class="col-sm-10">
...
<div class="container mt-2 text-center">
    ...
    if(!empty($_POST)) {
        ...
        if(verificaValor($valor) == 0) {
            echo "Número é Neutro!";
        } elseif (verificaValor($valor) == 1) {
