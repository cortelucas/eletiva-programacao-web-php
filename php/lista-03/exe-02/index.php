...
<section class="container card shadow-lg mt-5 p-5">
    ...
    <form method="post">
        <div class="form-group row">
            <label for="date" class="col-sm-2 col-form-label">Informe uma data: </label>
            <div class="col-sm-10">
    ...
    <div class="container mt-2 text-center">
        <?php
            function authDate($retDate) {
                if($retDate) {
                    $week = array('Domingo', 'Segunda', 'Terça', 'Quarta', 'Quinta', 'Sexta', 'Sábado');
                    $day = date('w', strtotime($retDate));
                    $date = date('d/m/Y', strtotime($retDate));

                    echo "No dia ",$date, " o dia da semana é ", $week[$day],"!";
                }else {
                    echo "Data inválida.";
                }
            }
