...
<head>
    ...
    <title>Inserir CD's</title>

</head>
<body>
<header class="card-header bg-white text-center">
    <h1>Inserir dados de CD's</h1>
</header>
<section class="container card shadow-lg mt-5 p-5">
    ...
    <form method="post">
        ...
        <div class="form-group row mt-2">
            <label for="musicalGenre" class="col-sm-2 col-form-label">Genero Musical: </label>
            <div class="col-sm-10">
                <input type="text" class="form-control" id="musicalGenre" name="musicalGenre">
            </div>
        </div>
        <div class="form-group row mt-2">
            <label for="idAudioTracks" class="col-sm-2 col-form-label">Faixas de áudio: </label>
            <div class="col-sm-10">
                <input type="text" class="form-control" id="idAudioTracks" name="idAudioTracks">
            </div>
        </div>
    ...
    <div class="container mt-5">
        <?php
        if ($_POST) {
           require "ClasseCDs.php";

           $obj = new \EmpresaXYZ\ClasseCDs(
                   $_POST['id'], $_POST['name'], $_POST['dateOfAcquisition'],
                   $_POST['listOfAuthors'], $_POST['musicalGenre'], $_POST['idAudioTracks']
           );
