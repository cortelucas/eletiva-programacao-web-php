...
<section class="container card shadow-lg mt-5 p-5">
    ...
    <form method="post">
        ...
        <div class="form-group row mt-2">
            <label for="generalDescription" class="col-sm-2 col-form-label">Descrições Gerais: </label>
            <div class="col-sm-10">
                <input type="text" class="form-control" id="generalDescription" name="generalDescription">
            </div>
        </div>
