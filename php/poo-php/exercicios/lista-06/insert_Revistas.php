...
<head>
    ...
    <title>Inserir Revistas</title>

</head>
<body>
<header class="card-header bg-white text-center">
    <h1>Inserir dados das Revistas</h1>
</header>
<section class="container card shadow-lg mt-5 p-5">
    ...
    <form method="post">
        ...
        <div class="form-group row mt-2">
            <label for="$publisher" class="col-sm-2 col-form-label">Principais Assuntos: </label>
            <div class="col-sm-10">
                <input type="text" class="form-control" id="$publisher" name="$publisher">
            </div>
        </div>
    ...
    <div class="container mt-5">
        <?php
        if ($_POST) {
            require "ClasseRevistas.php";

            $obj = new \EmpresaXYZ\ClasseRevistas(
                $_POST['id'], $_POST['name'], $_POST['dateOfAcquisition'],
                $_POST['listOfAuthors'], $_POST['yearOfPubication'], $_POST['volume'],
                $_POST['publisher'], $_POST['mainSubjects']
            );
